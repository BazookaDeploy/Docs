...
latex_documents = [
    (master_doc, 'Bazooka.tex', u'Bazooka Documentation',
     u'Bazooka', 'manual'),
]
...
man_pages = [
    (master_doc, 'bazooka', u'Bazooka Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Bazooka', u'Bazooka Documentation',
     author, 'Bazooka', 'One line description of project.',
     'Miscellaneous'),
]
